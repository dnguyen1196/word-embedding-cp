...
def InterpreterWrapper_CreateWrapperCPPFromFile(model_path):
    return _tensorflow_wrap_interpreter_wrapper.InterpreterWrapper_CreateWrapperCPPFromFile(model_path)
...
def InterpreterWrapper_CreateWrapperCPPFromBuffer(data):
    return _tensorflow_wrap_interpreter_wrapper.InterpreterWrapper_CreateWrapperCPPFromBuffer(data)
